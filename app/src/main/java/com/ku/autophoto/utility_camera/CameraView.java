...
public class CameraView extends FrameLayout implements CameraCore.OnCameraCoreEventListener {
    ...
    void initView(Context context) {
        ...
        /*
            ...
            which are the dimensions of the camera preview chosen by CameraCore.
        ...
        //Init cameraCore, the class which controls our camera.
        cameraCore = new CameraCore(context,surfaceView,((WindowManager)context.getSystemService(Context.WINDOW_SERVICE)).getDefaultDisplay());
        cameraCore.setOnCameraCoreEventListener(this);
    }
    ...
    public void startCamera(CameraCore.CameraType type) {
        cameraCore.startCamera(type);
    }

    public void stopCamera() {
        cameraCore.stopCamera();
    }

    public void takePhoto(Camera.PictureCallback picture, boolean flashOn) {
        cameraCore.takePhoto(picture, flashOn);
    }

    public int getCameraRotation(){
        return cameraCore.getCameraRotation();
    }
     ...
     * Notice that CameraCore notifies us of the physical, pre-rotation width and height of the camera
